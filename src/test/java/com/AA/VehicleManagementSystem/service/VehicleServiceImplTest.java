...
public class VehicleServiceImplTest {
    ...
    public void addVehicleWithExistingVRN() {
        ...
        assertThrows(InvalidVehicleException.class, () -> vehicleService.addVehicle(vehicle), "Vehicle with VRN TEST2 already exists.");
    }
    ...
    public void updateVehicleWithExistingVRN() {
        ...
        assertEquals(vehicle, vehicleService.updateVehicle("TEST2", vehicle));
    }
